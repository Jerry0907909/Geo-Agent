...
class ChromaManager:
    ...
    def similarity_search(
        ...
        logger.info(f"[ChromaManager] 检索: query='{query[:50]}...', top_k={n_results}, collection={self._collection_name}")
...
def search_all_collections(
    ...
    collections = list_all_collections(persist_directory)
    ...
    for coll_name in collections:
        try:
            ...
            docs = manager.similarity_search(query, top_k=top_k)
